...
export default function NoticiasPage() {
  ...
  // Filter categories to show only news
  ...
  const { data: newsPosts, isLoading: postsLoading } = useQuery<PostWithRelations[]>({
    queryKey: ["/api/posts", "news", searchFilters],
    queryFn: () => {
      const queryParams = buildQueryParams(searchFilters);
      const url = queryParams ? `/api/posts?${queryParams}` : '/api/posts?type=news';
  ...
  const handleAdvancedSearch = (filters: SearchFilters) => {
    setSearchFilters({ ...filters, type: "news" });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Fique por dentro das últimas novidades</p>
        </div>

        {/* Categories Grid */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">Categorias de Notícias</h2>
        ...
        <div className="mb-8">
          <AdvancedSearch 
            ...
            initialFilters={{ type: "news" }}
          />
        </div>

        {/* Add News Button */}
        <div className="mb-8 text-center">
          <Link href="/postar?type=news">
        ...
        {/* Posts Grid */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-6">Últimas Notícias</h2>
          {postsLoading ? (
